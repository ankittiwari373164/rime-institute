      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          <div className="text-gray-600 leading-relaxed space-y-4">
            ...
            <p>
              "I warmly welcome you to join RIMT Faridabad, a place where ambition meets opportunity, and where your journey towards success truly begins."
            </p>
          </div>
        </motion.div>
      </div>
